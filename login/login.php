...
<body class="get-started-body">
	...
	<section class="flex center col gap-32 get-started">
		<div class="flex col center gap-16">
			...
			<h2>Halaman Untuk mimin saja</h2>
		...
		<div class="flex col gap-32">
			...
			<div class="flex col center gap-8">
					<a href="" class="button">Gasss Masuk !!!!</a>
				<p>Disclaimer Hanya untuk admin, kalau kamu mau jadi admin DM aku aja</p>
